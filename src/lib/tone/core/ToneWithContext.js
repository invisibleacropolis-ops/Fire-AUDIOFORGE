...
export class ToneWithContext extends Tone {
    ...
    normalize(value, min, max) {
        return this.context.normalize(value, min, max);
    }
    /**
    ...
    denormalize(value, min, max) {
        return this.context.denormalize(value, min, max);
    }
    /**
     ...
     */
    midiToHz(midi) {
        return this.context.midiToHz(midi);
    }
    /**
     ...
     */
    hzToMidi(frequency) {
        return this.context.hzToMidi(frequency);
    }
    /**
     * Convert the given frequency to a MIDI note.
     * @param frequency The frequency to convert.
     */
    ftom(frequency) {
        return this.context.ftom(frequency);
    }
    /**
